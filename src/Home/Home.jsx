  ...
  return (
    <div>
      ...
      <div className="home-text1">
        <p className="para1">
          After several successful years as a commercial construction project
          manager, I've transitioned to the world of coding. I've dedicated over
          500 hours as a software engineering fellow. I'm excited to break into
          the technology field where my new skills will blossom as I bring all
          of my previous expertise along with the new languages and specialized
